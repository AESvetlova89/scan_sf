    ...
    <form className="search-form" onSubmit={handleSubmit(onSubmit)}>
      <div className="search-form__inputs">
        <label className="search-form__label">
          <span class="bubuholder"> ИНН компании <span>*</span></span>
          <input
            className={
              errors?.inn
          ...
          {errors?.inn && errors.inn.type === "maxLength" && (
            <p className="search-form__error-message">
                <span class="bubuholder"><span>Не более 10 цифр</span></span>
            </p>
          )}
          {errors?.inn && errors.inn.type === "pattern" && (
            <p className="search-form__error-message">
                <span class="bubuholder"><span>Введите корректные данные</span></span>
            </p>
          )}
        </label>
        <label className="search-form__label">
        ...
        <label className="search-form__label">
          <span class="bubuholder">Количество документов в выдаче <span>*</span></span>
          <input
            type="number"
            className={
              errors?.limit
        ...
        <div className="date-picker__wrapper">
          <p>
          <span class="bubuholder"> Диапазон поиска <span>*</span></span>
          </p>
      ...
      <div className="search-form__checks-wrapper">
        ...
        <div className="search-form__button">
          ...
          <p>
          <span class="bubuholder"><span> * </span> Обязательные к заполнению поля </span>
          </p>
        </div>
      </div>
    </form>
